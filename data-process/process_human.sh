...
main_dir=/scratch/wge/GTRD/human
...
${BAMMMOTIF} ${bamm_dir}/${bn} ${fasta_dir}/${bn}.fasta --PWMFile ${peng_dir}/${bn}.meme --maxPWM 1 --EM -k 4 --FDR -m 1 --scoreSeqset --extend 2 2 --threads 4 > ${logs_dir}/${bn}.bamm.logg
